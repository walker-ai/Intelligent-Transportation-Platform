...
class VideoCamera(object):
    def __init__(self):
        ...
        """
        由于每次上传之前都会将该目录清空，因此要预测的视频文件就是第一个文件
        """
        rootdir = r"F:/yolox/Yolov5-Flask-VUE-master/Yolov5-Flask-VUE-master/back-end/tmp/ct/"
        filelist = os.listdir(rootdir)
        video_path = rootdir + filelist[0]
        self.video = cv2.VideoCapture(video_path)  #换成自己的视频文件



        self.weights = 'weights/yolov5s.pt'   #yolov5权重文件
